...
The package is utilized by several prominent organizations and specialized software teams.

*   **Elastic** uses the package within their specification projects.
*   **Heinlein Support** and **CitySSM** integrate it into infrastructure monitoring and municipal record management systems.
*   **DXWorks** and **CausalLabs** maintain multiple repositories that depend on this tool for data analysis and sandboxing.

The package is a core component in various development and automation ecosystems.

*   **Groovy Linting**: It powers essential tools like **npm-groovy-lint** and **vscode-groovy-lint**.
*   **Checkmk**: Numerous forks and extensions of the **checkmk** IT monitoring platform rely on this package.
*   **MegaLinter**: It is integrated into the **megalinter** ecosystem for aggregated code analysis.
*   **Jenkins**: It is used in CI/CD workflows and **Jenkins** testing environments.

Several high-star repositories demonstrate the package's reach across different domains.

*   **Nomi-CEu/Nomi-CEu** (276 stars): A significant community edition project.
*   **nvuillam/npm-groovy-lint** (239 stars): A popular linting utility for Groovy.
*   **elastic/elasticsearch-specification** (150 stars): Formal specifications for the Elasticsearch API.
*   **oslabs-beta/saamsa** (49 stars): An open-source tool for microservices analysis.

## Package nvuillam/node-java-caller

[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by&message=159&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(public)&message=90&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(private)&message=69&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(stars)&message=858&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)

| Repository | Stars  |
| :--------  | -----: |
|<img class="avatar mr-2" src="https://avatars.githubusercontent.com/u/129654786?s=40&v=4" width="20" height="20" alt="">  &nbsp; [Nomi-CEu](https://github.com/Nomi-CEu) / [Nomi-CEu](https://github.com/Nomi-CEu/Nomi-CEu) | 276 |
