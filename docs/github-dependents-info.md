...
The `node-java-caller` package is utilized by 172 dependents, including 96 public repositories with a combined total of 895 stars.

The package is integrated into projects by several notable organizations and companies:

*   **Elastic** uses it within their specification repository.
*   **Heinlein Support** and **CitySSM** utilize the package for infrastructure and records management tools.
*   **CausalLabs** and **OSLabs-beta** maintain dependents for sandbox environments and specialized software.

Analysis of dependent repositories reveals its use across various tools and ecosystems:

*   **Groovy** development is a primary use case, seen in tools like **npm-groovy-lint** and **vscode-groovy-lint**.
*   **Checkmk** monitoring extensions frequently depend on this package for Java integration.
*   **MegaLinter** and other CI/CD linting tools incorporate it for multi-language support.
*   **Elasticsearch** tooling leverages it for managing specifications.

Several high-star repositories rely on this package:

*   **Nomi-CEu/Nomi-CEu** (291 stars)
*   **nvuillam/npm-groovy-lint** (247 stars)
*   **elastic/elasticsearch-specification** (155 stars)
*   **nvuillam/vscode-groovy-lint** (88 stars)
...
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(stars)&message=895&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
...
|<img class="avatar mr-2" src="https://avatars.githubusercontent.com/u/6764390?s=40&v=4" width="20" height="20" alt="">  &nbsp; [elastic](https://github.com/elastic) / [elasticsearch-specification](https://github.com/elastic/elasticsearch-specification) | 155 |
