...
*   **Cityssm** employs it for municipal tools like **corporate-records-manager** and **contract-expiration-tracker**.
*   **CausalLabs** and **Dxworks** utilize the package for internal sandboxes and repository analysis tools.

The repository names suggest the package is a key component in several development and automation ecosystems.

*   **Groovy** ecosystem: It is a core dependency for **npm-groovy-lint** and **vscode-groovy-lint**.
*   **Linting and CI/CD**: It is integrated into **MegaLinter** and various Jenkins-related automation scripts.
*   **Monitoring**: Multiple forks and implementations of **checkmk** rely on this package.
*   **Data Analysis**: Tools like **Bananalyzer** and **inspector-git** use it for processing and reporting.

Several high-star repositories depend on this package for critical functionality.

*   **Nomi-CEu/Nomi-CEu** (277 stars)
...
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(stars)&message=860&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)

| Repository | Stars  |
| :--------  | -----: |
|<img class="avatar mr-2" src="https://avatars.githubusercontent.com/u/129654786?s=40&v=4" width="20" height="20" alt="">  &nbsp; [Nomi-CEu](https://github.com/Nomi-CEu) / [Nomi-CEu](https://github.com/Nomi-CEu/Nomi-CEu) | 277 |
