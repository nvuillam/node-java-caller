...
*   **Cityssm** employs it for municipal software like **corporate-records-manager** and **contract-expiration-tracker**.
*   **CausalLabs** and **Collegiate-Edu-Nation** also maintain dependent repositories.

The package is a core component in several developer tools and software ecosystems:

*   **Groovy** development tools, including **npm-groovy-lint** and **vscode-groovy-lint**.
*   **MegaLinter**, a popular multi-language linting framework.
*   **Checkmk** monitoring extensions and plugins.
*   **DXWorks** analysis tools such as **inspector-git**, **depminer**, and **jafax**.

Several high-star repositories rely on this package for their functionality:

*   **Nomi-CEu/Nomi-CEu** (271 stars), a large-scale Minecraft modpack project.
*   **oslabs-beta/saamsa** (49 stars), a cloud infrastructure visualization tool.
*   **andreialecu/yarn-cache-remover** (7 stars), a utility for managing Yarn environments.
*   **docupike/docs** (5 stars), an IT documentation and asset management platform.
...
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(stars)&message=853&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
