...
The package is utilized by several notable organizations and companies, including **Elastic**, **Heinlein Support**, **CitySSM**, **CausalLabs**, and **DXWorks**.

The repository names indicate integration within various popular tools and ecosystems:
*   **Groovy** development via linting tools and Jenkins-related projects.
*   **Elasticsearch** through specification and data management utilities.
*   **Checkmk** monitoring extensions and plugins.
*   **MegaLinter** for multi-language code analysis.
*   **VS Code** extension development.

Several high-star repositories depend on this package to provide core functionality:
*   **Nomi-CEu/Nomi-CEu** (282 stars)
*   **nvuillam/npm-groovy-lint** (246 stars)
*   **elastic/elasticsearch-specification** (153 stars)
...
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(public)&message=98&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(private)&message=73&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(stars)&message=879&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
