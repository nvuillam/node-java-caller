...
The package is utilized by several prominent organizations and companies for various integration tasks.

*   **Elastic** uses the package within its **elasticsearch-specification** project.
*   **HeinleinSupport** integrates it into **checkMK** monitoring tools.
*   **Cityssm** employs it across multiple municipal management systems, including **corporate-records-manager** and **contract-expiration-tracker**.
*   **Dxworks** maintains the highest number of dependent repositories, focusing on analysis tools like **inspector-git** and **jafax**.

The repository names suggest the package is a key component in several software development and automation ecosystems.

*   **Groovy** ecosystem: It is a core dependency for **npm-groovy-lint** and **vscode-groovy-lint**.
*   **CI/CD and Linting**: The package is widely used in **MegaLinter** distributions and **Jenkins** pipeline testing.
*   **Monitoring**: Multiple forks and implementations of the **checkmk** monitoring platform rely on this package.

Several high-star repositories demonstrate the package's utility in complex applications.

*   **Nomi-CEu/Nomi-CEu**: A community edition project with 278 stars.
*   **oslabs-beta/saamsa**: A specialized tool with 49 stars.
*   **andreialecu/yarn-cache-remover**: A utility for managing **Yarn** environments with 7 stars.

## Package nvuillam/node-java-caller

[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by&message=162&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(public)&message=91&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
...
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(stars)&message=862&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
