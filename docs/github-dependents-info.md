...
The package is utilized by several prominent organizations and development teams across various industries.

*   **Elastic** uses the package within their specification repositories.
*   **Heinlein Support** and **Iteratio** integrate it into monitoring solutions.
*   **CitySSM** employs it for municipal management software and corporate record tracking.
*   **CausalLabs** and **OSLabs-Beta** utilize it for sandbox environments and specialized developer tools.

The repository names suggest the package is a key component in several technical ecosystems:

*   **Groovy & Jenkins**: Extensively used in **npm-groovy-lint**, **vscode-groovy-lint**, and CI/CD pipeline testing.
*   **Elasticsearch**: Integrated into **elasticsearch-specification** projects.
*   **Checkmk**: Frequently found in extensions and plugins for the **checkmk** IT monitoring platform.
*   **MegaLinter**: Included in various distributions of the **MegaLinter** universal linting tool.

Several high-star repositories depend on this package for core functionality:

*   **Nomi-CEu/Nomi-CEu** (283 stars): A major community edition project.
*   **nvuillam/npm-groovy-lint** (246 stars): A popular linting and fixing tool for Groovy.
*   **elastic/elasticsearch-specification** (154 stars): Formal specifications for the Elasticsearch API.
*   **oslabs-beta/saamsa** (49 stars): A notable open-source developer tool.

## Package nvuillam/node-java-caller

[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by&message=171&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(public)&message=97&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(private)&message=74&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(stars)&message=881&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)

| Repository | Stars  |
| :--------  | -----: |
|<img class="avatar mr-2" src="https://avatars.githubusercontent.com/u/129654786?s=40&v=4" width="20" height="20" alt="">  &nbsp; [Nomi-CEu](https://github.com/Nomi-CEu) / [Nomi-CEu](https://github.com/Nomi-CEu/Nomi-CEu) | 283 |
