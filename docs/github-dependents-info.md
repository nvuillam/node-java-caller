...
The `node-java-caller` package is utilized by 180 repositories, including 100 public projects with a combined total of 906 stars.

**Popular Companies and Organizations**

*   **Elastic** utilizes the package for their **elasticsearch-specification** project.

*   **HeinleinSupport** integrates it within their **checkMK** monitoring infrastructure.

*   **Cityssm** uses it across multiple municipal tools, including **corporate-records-manager** and **contract-expiration-tracker**.
...
*   **MegaLinter** and its various forks use the package for aggregated linting workflows.

*   **Groovy** development tools, specifically **npm-groovy-lint** and **vscode-groovy-lint**, rely on it for Java-based linting execution.

*   **Checkmk** extensions and plugins form a significant portion of the dependent ecosystem.

*   **Cypress** automation frameworks and **Yarn** cache utilities are also represented among dependents.

**Notable High-Star Dependent Repositories**

*   **Nomi-CEu/Nomi-CEu**: A prominent community edition project with 293 stars.

*   **nvuillam/npm-groovy-lint**: A widely used linting tool with 248 stars.

*   **oslabs-beta/saamsa**: A notable open-source project with 49 stars.

## Package nvuillam/node-java-caller

[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by&message=180&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(public)&message=100&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(private)&message=80&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(stars)&message=906&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
...
|<img class="avatar mr-2" src="https://avatars.githubusercontent.com/u/34131810?s=40&v=4" width="20" height="20" alt="">  &nbsp; [cityssm](https://github.com/cityssm) / [contract-expiration-tracker](https://github.com/cityssm/contract-expiration-tracker) | 5 |
...
|<img class="avatar mr-2" src="https://avatars.githubusercontent.com/u/131896721?s=40&v=4" width="20" height="20" alt="">  &nbsp; [LyingDoc](https://github.com/LyingDoc) / [printer-pdf](https://github.com/LyingDoc/printer-pdf) | 2 |
