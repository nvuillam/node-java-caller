...
This package is utilized by several prominent organizations and companies, including **elastic**, **HeinleinSupport**, **cityssm**, **CausalLabs**, and **Collegiate-Edu-Nation**.

The library is integrated into various tools and ecosystems, particularly those focused on:

*   **Groovy** development and linting via **npm-groovy-lint** and **vscode-groovy-lint**.
*   **Monitoring** and system checks through multiple **checkmk** implementations.
*   **CI/CD** and code quality workflows using **megalinter** and **jenkins**.
*   **Data analysis** and software forensics with the **dxworks** suite, including **inspector-git** and **jafax**.

Several high-star repositories depend on this package to facilitate Java-related operations:

*   **Nomi-CEu/Nomi-CEu** (278 stars)
*   **nvuillam/npm-groovy-lint** (242 stars)
*   **elastic/elasticsearch-specification** (151 stars)
*   **nvuillam/vscode-groovy-lint** (84 stars)
*   **oslabs-beta/saamsa** (49 stars)

## Package nvuillam/node-java-caller

[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by&message=163&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(public)&message=92&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
...
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(stars)&message=863&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
