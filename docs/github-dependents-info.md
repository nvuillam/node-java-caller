...
The `node-java-caller` package is utilized by 171 dependents, including 97 public repositories, with a combined total of 884 stars.

**Popular Companies and Organizations**

*   **Elastic** uses the package for their **elasticsearch-specification** project.
*   **Heinlein Support** integrates it into their **checkMK** monitoring solutions.
*   **CitySSM** utilizes it across multiple municipal management tools like **corporate-records-manager**.
*   **Dxworks** maintains several analysis tools including **inspector-git** and **depminer**.
*   **CausalLabs** employs the package within their **sandbox** and **examples** environments.

**Popular Tools and Ecosystems**

*   **Groovy** development is a primary use case, seen in tools like **npm-groovy-lint** and **vscode-groovy-lint**.
*   **Checkmk** monitoring extensions are frequently built using this package by various contributors.
*   **MegaLinter** includes it as a dependency for broad code quality automation.
*   **Elasticsearch** tooling leverages the package for specification management.

**Notable High-Star Dependent Repositories**

*   **Nomi-CEu/Nomi-CEu**: A prominent project with 285 stars.
*   **nvuillam/npm-groovy-lint**: A popular linting utility with 246 stars.
*   **oslabs-beta/saamsa**: An open-source project with 49 stars.
*   **andreialecu/yarn-cache-remover**: A utility for managing package manager caches.
...
[![Generated by github-dependents-info](https://img.shields.io/static/v1?label=Used%20by%20(stars)&message=884&color=informational&logo=slickpic)](https://github.com/nvuillam/node-java-caller/network/dependents)
